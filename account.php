            ...
            <div>
                <form action="actions/updateprofile.action.php" method="POST" class="row g-3 p-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" placeholder="Dev Ninja" value="<?= @$user['full_name'] ?>" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" name="email_id" value="<?= @$user['email_id'] ?>" placeholder="dev@abc.com" class="form-control" required>
                    </div>
                    <div class="col-12">
